...
`;
	...
	function Item({
	  ...
	  return /*#__PURE__*/React.createElement("div", {
	    className: "flex flex-row flex-wrap mx-10 gap-4 text-center justify-start md:justify-center items-center w-full"
