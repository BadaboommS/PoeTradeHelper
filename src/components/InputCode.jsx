        ...
        <form className='flex flex-col justify-center items-center gap-2' onSubmit={handleSubmit}>
            ...
            <div className='flex flex-col md:flex-row justify-center items-center gap-2'>
                <select className='w-50 h-10 text-center' defaultValue="Necropolis" id="leagueSelect">
                    ...
                    <option value="Ruthless%20Settlers">Ruthless Settlers</option>
                    <option value="Ruthless">Ruthless</option>
                    <option value="Hardcore%20Settlers">Hardcore Settlers</option>
                    <option value="Hardcore">Hardcore</option>      
                    <option value="HC%20Ruthless%20Settlers">HardCore Ruthless Settlers</option>
